...
const sparseMatrixShimPath = fileURLToPath(
  new URL('./src/vendor/ml-sparse-matrix.ts', import.meta.url),
);
const nmrSimulationSourcePath = fileURLToPath(
  new URL('./node_modules/nmr-simulation/src/index.js', import.meta.url),
);
