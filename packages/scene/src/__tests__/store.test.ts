...
describe('set-nmr-prediction command', () => {
  it('stores NMR prediction on the active page', () => {
    ...
    const prediction: NmrPrediction = {
      nucleus: '1H',
      solvent: 'CDCl3',
      peaks: [{ atom_index: 0, atom_indices: [0], parent_indices: [0], shift_ppm: 7.3, integral: 1, multiplicity: 's', coupling_hz: [], environment: 'aromatic', confidence: 3, method: 'additive' }],
